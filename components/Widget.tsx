...
export default function Widget() {
  ...
  return (
    <div className="max-w-[392px] w-full">
      {step === "op" && (
        <div className="card">
          <StepHeader
      ...
      {step === "cal" && (
        <div className="space-y-3">
          ...
          {/* Modal de vuelos (sin selector ICN/GMP; el backend ya prueba ambos) */}
          <FlightsModal
            open={modal}
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              <button className="btn btn-secondary" onClick={() => setStep("cal")}>
                Atrás
              </button>
      ...
      {step === "sum" && (
        <div className="card">
          ...
          <div className="text-sm space-y-1">
            ...
            <div>
              Vuelo: <strong>{flightId ? "Seleccionado" : "No seleccionado"}</strong>
            </div>
            <div>
              Alojamiento:{" "}
